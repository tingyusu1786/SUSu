...
const ItemCatalogue: React.FC<CatalogueProps> = ({
  pageItemId,
  catalogueItemName,
  catalogueItemObj,
}) => {
  return (
    <div className='mx-auto mt-5 max-w-[960px]'>
      <div className='flex items-baseline gap-5 sm:flex-col sm:gap-0'>
        <h1 className='mb-3 mt-1 inline-block text-6xl selection:bg-green-400 sm:text-5xl'>
          {catalogueItemName}
        </h1>
      ...
      <PostsFeed currentPage='item' pageItemId={pageItemId} />
    </div>
  );
};
